...
import static com.example.sylvain.applicationmeteo.releveList.*;


public class releveActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tr.setAdapter(new releveActivityAdapter(this,test.getArrayList()));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_releve, menu);
        return true;
    }
